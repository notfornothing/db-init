...
import io.github.dingdangdog.dbinit.enums.DbTypeEnum;
...
public class DbInitConfiguration {
    ...
    public DbInitConfiguration(String url, String baseName, String username, String password) {
        this.initType = 2;
        this.url = url;
